  ...
  return (
    ...
    >
      ...
      >        
        ...
        <br />
        <em>STRUDEL is an open source project housed at the Berkeley Institute for Data Science <Link href="https://bids.berkeley.edu/" target="_blank" rel="noreferrer">(BIDS)</Link> at the University of California, Berkeley. The project is generously funded by the Alfred P. Sloan Foundation, Liz Vu & Josh Greenberg Program Officers, grants <Link href="https://sloan.org/grant-detail/g-2022-19360" target="_blank" rel="noreferrer">G-2022-19360</Link>, <Link href="g-2023-21098" target="_blank" rel="noreferrer">G-2023-21098</Link>, and <Link href="https://sloan.org/grant-detail/g-2024-22557" target="_blank" rel="noreferrer">G-2024-22557</Link>. STRUDEL partners include members of the Lawrence Berkeley National Lab Scientific Data <Link href="https://crd.lbl.gov/divisions/scidata/" target="_blank" rel="noreferrer">(SciData)</Link> Division <Link href="https://ux.lbl.gov" target="_blank" rel="noreferrer">UX team</Link></em>, <Link href="https://superbloom.design/" target="_blank" rel="noreferrer">Superbloom Design</Link>, <Link href="https://carpentries.org/" target="_blank" rel="noreferrer">The Carpentries</Link>, and <Link href="https://2i2c.org/" target="_blank" rel="noreferrer">2i2c</Link>.
      </Container>
    </Box>
  )
};