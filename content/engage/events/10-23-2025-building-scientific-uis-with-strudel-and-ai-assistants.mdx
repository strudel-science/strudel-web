...
shortDescription: 'Join the STRUDEL team at Berkeley Lab on Oct 23, 2025, for an in-person hackathon to build scientific web UIs using STRUDEL Design System and generative AI coding tools. Familiarity with GitHub Copilot, VS Code, and Node.js will be useful but you do not need to be an expert web developer'
