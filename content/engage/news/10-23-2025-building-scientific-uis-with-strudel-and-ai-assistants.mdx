---
title: 'Dynamic Workshop Builds Scientific UIs with STRUDEL and AI Assistants'
...
Reducing the burden of setting up a development environment when prototyping was another key takeaway. With our colleagues at <a href="http://2i2ic.org" target="_blank"> 2i2c</a>, STRUDEL created a dedicated environment pre-configured with everything an end user needs to begin prototyping from their browser window. The space provided by 2i2c allowed STRUDEL to test and configure the Cline VS Code extension along with OpenRouter. Adopting OpenRouter to provide access to a wide range of cutting edge AI models for coding ensured that workshop participants could select among a range of models. Individuals were even able to swap between models over the day to test performance and features. All while working in an environment optimized for prototyping with STRUDEL Design System.
