...
<ProjectHistoryStepper>
    ...
    <ProjectHistoryStep>
      ...
      <StepContent>
        The Alfred P. Sloan Foundation <Link href="https://sloan.org/grant-detail/10074" target="_blank"> funded</Link> the team at LBNL to create a typology and design system for scientific software after team participated in a <Link href="https://web.cvent.com/event/1b7d7c3a-e9b4-409d-ae2b-284779cfe72f/summary" target="_blank">DOE workshop</Link> on the Science of Scientific Software Development and Use.
      </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
    </ProjectHistoryStep>
