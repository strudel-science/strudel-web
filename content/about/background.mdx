...
<Grid container columnSpacing={4}>
    <Grid item sm={8}>
        STRUDEL is generously funded by the Alfred P. Sloan Foundation, Liz Vu & Josh Greenberg Program Officers, initial grant <Link href="https://sloan.org/grant-detail/10074" target="_blank" rel="noreferrer">#10074</Link>.
    </Grid>
    <Grid item sm={4}>
...
<ProjectHistoryStepper>
    <ProjectHistoryStep>
      ...
      <StepContent>
        STRUDEL launched the initial version of a design system oriented around <Link href="/about/glossary#task-flow">Task Flows</Link>, including visual design templates, guidelines, and code.
      </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
      <StepLabel>
        ### Formation of US-RSE UX Working Group – Nov 2024
      </StepLabel>
      <StepContent>
    ...
    <ProjectHistoryStep>
      ...
      <StepContent>
        STRUDEL team generalized common patterns uncovered during the audit to generate <Link href="/about/glossary#task-flow">Task Flows</Link> which can be used across different science domains and use cases.  
      </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
      <StepLabel>
    ...
    <ProjectHistoryStep>
      ...
      <StepContent>
        Team members <Link href="https://dx.doi.org/10.5334/jors.284" target="_blank">published</Link> experiences with adopting a flexible UX research process to influence scientific software development to raise awareness of user experience challenges.
      </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
      <StepLabel>
      ...
      <StepContent>
        Data Science & Technology group leaders published eScience conference paper outlining <Link href="https://ieeexplore.ieee.org/document/8109139" target="_blank">core principles</Link> for building usable science software based on team’s experiences.
      </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
        <StepLabel>
        ...
        <StepContent>
            Data Science & Technology Department <Link href="https://ux.lbl.gov" target="_blank">UX group</Link> funded by <Link href="https://science.osti.gov/ascr" target="_blank">DOE ASCR</Link> to conduct foundational R&D with UX approach across variety of products. 
        </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
        <StepLabel>
        ...
        <StepContent>
            Team <Link href="https://ieeexplore.ieee.org/document/6972276" target="_blank">published</Link> experiences applying user centered design practices to scientific workflow API development.
        </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
        <StepLabel>
            ### Early LBNL Computing Sciences Area UX group formed — ~2012-2013
        </StepLabel>
        <StepContent>
            Team formed a <Link href="https://ux.lbl.gov" target="_blank">group</Link> with members bringing UX experience and applying to a range of scientific softwares and new research software initiatives witin LBNL <Link href="https://cs.lbl.gov" target="_blank">Computing Sciences Area</Link>.
        </StepContent>
    </ProjectHistoryStep>
    <ProjectHistoryStep>
      <StepLabel>
      ...
      <StepContent>
        Teams in Data Science & Technology Department (now <Link href="https://crd.lbl.gov/divisions/scidata/" target="_blank">Scientific Data Division</Link>) began adopting user centered design practices when building scientific software.
      </StepContent>
    </ProjectHistoryStep>
</ProjectHistoryStepper>
