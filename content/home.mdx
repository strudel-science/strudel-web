  ...
  <Grid container spacing={4} sx={{ minHeight: '300px' }}>
    <Grid item md={4}>
      <ContentCard variant="light" sx={{ height: '100%' }}>
        ...
        >
          <Box>
            ## STRUDEL Team hosted a dynamic workshop to Build Scientific UIs with STRUDEL and AI Assistants

            Thirty plus scientists and research software engineers went from idea to interactive prototype in a day using STRUDEL and AI Assistants.<br/>
            
          </Box>
          <Box marginTop="16px">
            <Button 
              to="/engage/news/10-23-2025-building-scientific-uis-with-strudel-and-ai-assistants/"
              target="_blank"
              size="large"
              endIcon={<ArrowForwardIcon />}
            >
    ...
    <Grid item md={4}>
      <ContentCard variant="light" sx={{ height: '100%' }}>
        ...
        >
          <Box>
            ## STRUDEL leads a workshop on conducting User Interviews with over 50 participants at US-RSE '25 

            The STRUDEL team hosted a hands-on, in-person workshop at the <a href="https://us-rse.org/usrse25/program/" target="_blank">US-RSE 2025 Conference</a> in Philadelphia, providing research engineers with hands-on training on conducting semi-structured user interviews.
          </Box>
          <Box marginTop="16px">
            <Button 
              to="/engage/news/10-06-2025-learning-to-talk-with-your-users/"
              target="_blank"
              size="large"
              endIcon={<ArrowForwardIcon />}
            >
