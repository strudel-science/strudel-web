  ...
  <Grid container spacing={4} sx={{ minHeight: '300px' }}>
    <Grid item md={4}>
      <ContentCard variant="light" sx={{ height: '100%' }}>
        ...
        >
          <Box>
            ## STRUDEL Team hosted a lively workshop to Build Scientific UIs with STRUDEL and AI Assistants

            Thirty plus scientists and research software engineers went from idea to interactive prototype in a day using STRUDEL.<br/>
