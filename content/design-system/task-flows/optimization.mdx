...
title: 'Optimization'
subtitle: 'Running optimizations, simulations, analyses'
intent: 'Enable users to run calculations/ optimizations/ simulations on a pre-defined/ newly created/ altered model with attributes to observe and compare results to help users make data-driven decisions/ improve performance/ reduce costs/ increase safety/ reduce risk in a variety of fields and applications'
---
...
<Grid container spacing={4}>
  <Grid item md={4}>
    <TaskFlowCard title="Test" subtitle="Test test test" />
  </Grid>
  <Grid item md={4}>
    <TaskFlowCard title="Test" subtitle="Test test test" />
  </Grid>
