...
<PageContainer> 
  ...
  The best way to get started building is using the STRUDEL CLI, a simple command-line tool to help you scaffold a a web application based on the STRUDEL Design System and its supported task flows.
